<x-dynamic-component :component="$getEntryWrapperView()" :entry="$entry">
    <div>
        ...
        <div class="progress-container">
            <div class="progress-bar" style="width: {{ $displayProgress }}%; background-color: {{ $progressColor }};">
                <div class="progress-text">
                    <small @class([ 'text-gray-700'=> $displayProgress != 100,
                        'text-white' => $displayProgress >= 60
                        ])>
                        {{ $displayProgress }}%
                    </small>
                </div>
